...
public class Fujii {
	...
	public static void main(String args[]) throws Exception{
		...
		System.out.println(getXMLContents(10,sample_list,url));
	}
    ...
    */
    public static List<String> getXMLContents(int i,List<String> p,String url) throws SAXException, IOException, ParserConfigurationException{
